...
{
    cout << "enter the loogin" << endl; 
    string ip ;
    string name ;
    string mysql ;
    readMysqlConfig read("/home/luo/server_improve/server_config/mysql.json");
    ip = read.getIP();
    name =read.getUsername();
    mysql = read.getPasswd();
    
    cout << ip << endl << name << endl << mysql << endl;
    ...
    cout << "success connect the database" << endl;
...
int regist(int fd, char *json)
{
    ...
    string name ;
    string mysql ;
    //readMysqlConfig read("~/server_improve/server_config/mysql.json");
    readMysqlConfig read("/home/luo/server_improve/server_config/mysql.json");
    ip = read.getIP();
    name =read.getUsername();
    mysql = read.getPasswd();
...
void child(void){
    ...
    int ret = execl ("/home/luo/server_improve/src/Funation/goquery","goquery" , arg[0] , arg[1] , NULL) ;
    if (ret < 0)
    { 
